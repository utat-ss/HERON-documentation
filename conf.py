...
# Import CommonMarkParser and set it as the source parser for local .md files
...
htmlhelp_basename = 'utatss-documentationdoc'
...
man_pages = [
    (master_doc, 'utatss-documentation', 'utatss-documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'utatss-documentation', 'utatss-documentation Documentation',
     author, 'utatss-documentation', 'One line description of project.',
     'Miscellaneous'),
]
