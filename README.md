...
Eventually, this book will contain most of what you need to know to start developing for any _real-time embedded system_. In addition to that, it will contain all of the guides to get you set up with our _toolchain_ and _libraries_ you need to properly start developing code for our custom systems.
